...
//            conn.setAutoCommit(true);
    ...
    public List<User> selectAllUsersStore() {
        List<User> users = new ArrayList<>();
        try (Connection connection = getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement("{call get_all_user()}");) {
            System.out.println(preparedStatement);
            ResultSet rs = preparedStatement.executeQuery();
            while (rs.next()) {
                int id = rs.getInt("id");
    ...
    public List<User> selectAllUsersSortedByNameStore() {
        ...
        try (Connection connection = getConnection();
             ...
             // Step 2:Create a statement using connection object
             PreparedStatement preparedStatement = connection.prepareStatement("{call get_all_users_sorted_by_name()}");) {
            System.out.println(preparedStatement);
            // Step 3: Execute the query or update query
            ResultSet rs = preparedStatement.executeQuery();
